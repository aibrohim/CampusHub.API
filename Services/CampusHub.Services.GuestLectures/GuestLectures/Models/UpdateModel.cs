...
public class UpdateModelProfile : Profile
{
    ...
    {
        CreateMap<UpdateModel, GuestLecture>()
            .ForMember(dest => dest.RoomId, opt => opt.Ignore())
            .ForMember(dest => dest.GuestId, opt => opt.Ignore())
            .AfterMap<UpdateModelActions>();
    }

    public class UpdateModelActions : IMappingAction<UpdateModel, GuestLecture>
    {
        ...
        public void Process(UpdateModel source, GuestLecture destination, ResolutionContext context)
        {
...
public class UpdateGuestLectureModelValidator : AbstractValidator<UpdateModel>
{
    public UpdateGuestLectureModelValidator(IDbContextFactory<MainDbContext> contextFactory)
    {
        RuleFor(x => x.Title)
