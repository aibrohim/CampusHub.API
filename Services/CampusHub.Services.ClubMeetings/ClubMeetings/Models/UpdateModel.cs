...
public class UpdateModelProfile : Profile
{
    ...
    {
        CreateMap<UpdateModel, ClubMeeting>()
            .ForMember(dest => dest.RoomId, opt => opt.Ignore())
            .ForMember(dest => dest.ClubId, opt => opt.Ignore())
            .AfterMap<UpdateModelActions>();
    }

    public class UpdateModelActions : IMappingAction<UpdateModel, ClubMeeting>
    {
        ...
        public void Process(UpdateModel source, ClubMeeting destination, ResolutionContext context)
        {
...
public class UpdateClubMeetingModelValidator : AbstractValidator<UpdateModel>
{
    public UpdateClubMeetingModelValidator(IDbContextFactory<MainDbContext> contextFactory)
    {
        RuleFor(x => x.Title)
