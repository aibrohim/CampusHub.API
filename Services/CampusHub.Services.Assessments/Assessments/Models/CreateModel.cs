...
public class CreateModelProfile: Profile
{
    ...
    {
        CreateMap<CreateModel, Assessment>()
            .ForMember(dest => dest.RoomId, opt => opt.Ignore())
            .ForMember(dest => dest.ModuleId, opt => opt.Ignore())
            .AfterMap<CreateModelActions>();
    }

    public class CreateModelActions : IMappingAction<CreateModel, Assessment>
    {
        ...
        public void Process(CreateModel source, Assessment destination, ResolutionContext context)
        {
...
public class CreateAssessmentModelValidator : AbstractValidator<CreateModel>
{
    public CreateAssessmentModelValidator(IDbContextFactory<MainDbContext> contextFactory)
    {
        RuleFor(x => x.Title)
